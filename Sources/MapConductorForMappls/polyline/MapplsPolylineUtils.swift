...
func createMapplsLines(
    ...
    // Mappls (MapLibre GL) accepts longitudes beyond +/-180, so an unwrapped
    ...
    let feature = MGLPolylineFeature(coordinates: &coords, count: UInt(coords.count))
