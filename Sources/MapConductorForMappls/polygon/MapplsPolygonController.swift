...
@MainActor
final class MapplsPolygonController: PolygonController<[MGLPolygonFeature], MapplsPolygonOverlayRenderer> {
    private weak var mapView: MGLMapView?

    init(mapView: MGLMapView?) {
        self.mapView = mapView

        let polygonManager = PolygonManager<[MGLPolygonFeature]>()
        ...
        let renderer = MapplsPolygonOverlayRenderer(
            mapView: mapView,
